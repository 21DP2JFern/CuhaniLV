    ...
    <div className="flex flex-row w-full h-full">
      ...
      <div className="flex flex-col bg-main-white h-[100%] w-[40%]">
        <div className="flex flex-col mt-[45%] mx-auto h-[40%] w-[30%]">
          <input className="h-14 bg-main-white border-main-gray text-main-gray text-lg indent-2 border-solid border-2 rounded-md focus:border-main-red outline-none focus:border-3" type="email" placeholder="E-mail"></input>
          <input className="h-14 mt-4 bg-main-white border-main-gray text-main-gray text-lg indent-2 border-solid border-2 rounded-md focus:border-main-red outline-none focus:border-3" type="password" placeholder="Password"></input>
          ...
          <button className="bg-main-red text-main-white h-14 rounded-md font-bold text-xl">Register</button>
        </div>
      </div>
    </div>
  );
